...
@CopyWith()
@JsonSerializable()
class BioIo implements SelectProc {
  String? localId;
  ...
  BioIo({
    this.localId,
    this.localRegDateTime,
    this.localUpdDateTime,
    this.comAddress,
    this.comCode,
    this.comName,
    this.company,
